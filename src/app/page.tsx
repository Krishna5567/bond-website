          ...
          <div className="bg-[#111916] border border-[#1B3B2B] rounded-2xl p-6 sm:p-8 flex flex-col md:flex-row items-start gap-6 hover:border-[#00A86B] transition-all">
            ...
            <div className="flex-1">
              ...
              <p className="text-xs sm:text-sm text-[#9CA3AF] leading-relaxed mb-4">
                Click the <strong className="text-white">Download Bond-Setup-x64.exe</strong> button at the top of this page. The download size is ~145 MB and contains all required binaries, including embedded on-device Whisper models and native C++ runtimes.
              </p>
            ...
            <div className="flex-1">
              ...
              <div className="bg-[#0a0f0d] border border-[#1B3B2B] rounded-xl p-4 text-xs text-[#9CA3AF] space-y-2">
                ...
                <p className="text-[11px] text-[#6B7280]">
                  Bond is 100% verified, clean, virus-free, and safe for your PC.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="max-w-5xl mx-auto px-4 sm:px-8 py-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="bg-[#111916] border border-[#1B3B2B] rounded-2xl p-5">
            ...
            <p className="text-xs text-[#9CA3AF] leading-relaxed">
              Check out the official video tutorials on the <a href={YOUTUBE_CHANNEL_URL} target="_blank" rel="noreferrer" className="text-[#10B981] hover:underline font-bold">Krishna Tech YouTube channel</a>.
            </p>
          </div>
